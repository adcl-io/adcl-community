# ADCL Platform Development Guide - Amazon Q Developer
...
# Bad
api_key = "AKIAIOSFODNN7EXAMPLE"  # NEVER
```
...
**ALWAYS** run these reviews after completing code changes:

#### 1. Quality Assurance Review
Run this review **proactively** after:
...
#### 2. linus Agent - Architectural Review
**Delegate to the linus agent** **proactively** after:
...
2. Run quality assurance review
3. Address any issues found
4. Delegate to linus agent for architectural review
...
- **MUST** run both reviews before committing
- Type changes affect system contracts and architecture
- Get feedback from both QA and delegate to linus agent for architecture perspectives
- Document type migration strategy if breaking changes

### Examples Requiring Code Review

**Requires both reviews:**
