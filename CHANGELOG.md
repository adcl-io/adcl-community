...
### Changes
- PRD-144: Fix community-upgrade.sh to download release files and upgrade properly (#55)
- PRD-140: Add docker-compose compatibility across different Docker versions (#53)
...
### Changes
- Make release script idempotent - delete and recreate releases
- Release v0.1.24
- Update community install to build from source instead of registry (#49)
- Fix model editing UI and OpenAI tool calling issues (#48)
- Improve agent execution UI - compact intermediate steps (#46)
